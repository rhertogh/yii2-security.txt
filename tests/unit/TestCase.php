...
abstract class TestCase extends \Codeception\Test\Unit
{
    ...
    public $privateCryptKeyPath = '@Yii2SecurityTxtTests/_config/keys/private.key';
    public $privateCryptKeyPassPhrase = 'secret';
    public $publicCryptKeyPath = '@Yii2SecurityTxtTests/_config/keys/public.key';
    ...
    public static function getParam($name, $default = null)
    {
        if (static::$params === null) {
            static::$params = require(Yii::getAlias('@Yii2SecurityTxtTests/_data/config.php'));
        }
    ...
    protected function getMockConsoleAppConfig($config = []): array
    {
        return ArrayHelper::merge(
            require(Yii::getAlias('@Yii2SecurityTxtTests/_config/main.php')),
    ...
    {
        return ArrayHelper::merge(
            require(Yii::getAlias('@Yii2SecurityTxtTests/_config/site.php')),
            [
                'basePath' => __DIR__,
